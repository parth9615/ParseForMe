...
public extension NSDate {
    ...
    public var time : NSDate {
        get {
            var past = NSDate.distantPast() as! NSDate
    ...
    class func dateToMinute(date:NSDate=NSDate()) -> NSDate {
        let calendar = NSCalendar.currentCalendar()
        let components = calendar.components(.CalendarUnitMonth | .CalendarUnitDay | .CalendarUnitYear | .CalendarUnitHour | .CalendarUnitMinute, fromDate: date)
        return calendar.dateFromComponents(components)!
    }
    
    class func date(hour:Int, minute:Int, second:Int, fromDate:NSDate) -> NSDate {
        let calendar = NSCalendar.currentCalendar()
        let components = calendar.components(.CalendarUnitMonth | .CalendarUnitDay | .CalendarUnitYear, fromDate: fromDate)
