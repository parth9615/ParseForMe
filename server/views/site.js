...
$(document).ready( function() {
  ...
  var eventArray = [
    ...
    {date : '2015-12-09', title: 'bullsht'},
    {date : '2015-12-09', title: 'KK'},
    {date : '2015-12-09', title: 'for wath'},
     {date : '2016-01-09', title: 'assface'},
    // events = [
    // {
    //     date: "2016-01-03 or some other ISO Date format",
    //     and: "goo fukkc yourself"
    // }
  ];
      ...
      click: function(target) {
       ...
       // alert(typeof(target['events'][0]['title']))
        ...
        for(var i=0; i<target['events'].length; i++){
          content += '<tr><td>' + target['events'][i]['title'] + '</td></tr>';
        }
        content += "</table>"
